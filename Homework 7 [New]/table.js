...
Updated on 20 November 2016, 04:52PM
*/
...
function validateForm() {
   ...
   if (h_start > h_end) {
      ...
      $(".container").before("<p class = 'switch'><b>Your Starting Horizontal Number was larger than your Ending Horizontal Number, so I switched them automatically.</b></p>");
   ...
   if (v_start > v_end) {
      ...
      $(".container").before("<p class = 'switch'><b>Your Starting Vertical Number was larger than your Ending Vertical Number, so I switched them automatically.</b></p>");
   }
